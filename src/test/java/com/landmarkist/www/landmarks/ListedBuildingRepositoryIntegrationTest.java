...
public class ListedBuildingRepositoryIntegrationTest {
    ...
    private static final DockerImageName postgisImage = DockerImageName.parse("postgis/postgis:13-3.1-alpine").asCompatibleSubstituteFor("postgres");
    ...
    @Test
    void givenAPolygon__whenListedBuildingsAreInThePolygon__thenReturnFoundListedBuildings() throws MalformedURLException {
